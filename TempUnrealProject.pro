...
unrealRootPath=/home/robin/UnrealEngine
TempUnrealProjectRootPath=/home/robin/Master/Mif28LogEdu/Projet/TempUnrealProject

gameProjectFile=/home/robin/Master/Mif28LogEdu/Projet/TempUnrealProject/TempUnrealProject.uproject
...
include(TempUnrealProjectSource.pri)
include(TempUnrealProjectHeader.pri)
include(TempUnrealProjectConfig.pri)
include(TempUnrealProjectIncludes.pri)
include(TempUnrealProjectDefines.pri)

TempUnrealProject-Linux-Debug.commands = $$build TempUnrealProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
TempUnrealProject-Linux-DebugGame.commands = $$build TempUnrealProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TempUnrealProject-Linux-Shipping.commands = $$build TempUnrealProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TempUnrealProject-Linux-Test.commands = $$build TempUnrealProject Linux Test  -project="\"$$gameProjectFile\"" $$args
TempUnrealProject.commands = $$build TempUnrealProject Linux Development  -project="\"$$gameProjectFile\"" $$args

TempUnrealProjectEditor-Linux-Debug.commands = $$build TempUnrealProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
TempUnrealProjectEditor-Linux-DebugGame.commands = $$build TempUnrealProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TempUnrealProjectEditor-Linux-Shipping.commands = $$build TempUnrealProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TempUnrealProjectEditor-Linux-Test.commands = $$build TempUnrealProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
TempUnrealProjectEditor.commands = $$build TempUnrealProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	TempUnrealProject-Linux-Debug \
	TempUnrealProject-Linux-DebugGame \
	TempUnrealProject-Linux-Shipping \
	TempUnrealProject-Linux-Test \
	TempUnrealProject \
	TempUnrealProjectEditor-Linux-Debug \
	TempUnrealProjectEditor-Linux-DebugGame \
	TempUnrealProjectEditor-Linux-Shipping \
	TempUnrealProjectEditor-Linux-Test \
	TempUnrealProjectEditor \
