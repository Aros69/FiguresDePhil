...
TempUnrealProject-Linux-Debug:
	 $(PROJECTBUILD) TempUnrealProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProject-Linux-DebugGame:
	 $(PROJECTBUILD) TempUnrealProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProject-Linux-Shipping:
	 $(PROJECTBUILD) TempUnrealProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProject-Linux-Test:
	 $(PROJECTBUILD) TempUnrealProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProject:
	 $(PROJECTBUILD) TempUnrealProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) TempUnrealProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TempUnrealProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) TempUnrealProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProjectEditor-Linux-Test:
	 $(PROJECTBUILD) TempUnrealProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TempUnrealProjectEditor:
	 $(PROJECTBUILD) TempUnrealProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
